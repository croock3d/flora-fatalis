...
public class GetPlantPhotoContentUseCaseHandler implements GetPlantPhotoContentUseCase {
  ...
  @Override
  public PhotoContent get(UserId userId, PlantPhotoId photoId) {
    ...
    return new PhotoContent(photo, photoStorage.load(photo.storageKey()));
  }
}
